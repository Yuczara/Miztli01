...
<div class="card-deck">
<div><a href="detalle2.html">
        <?php
            echo '<img src="../'.$tem[1]['url_img'].'" class="rounded float-left" alt="articulo1" style="padding: 3rem;">';     
        ?>
        </a>
    </div>
    ...
    <div>
        <?php
         echo '<h1 style="padding-top: 3rem;">'.$tem[1]['name'].'</h1>'; 
    
         echo '<h3>'.$tem[1]['description'].'</h3>'; 
         echo '<h3 style="color: red; ">'.$tem[1]['price_venta'].',00 MXN.</h3>'; 
