...
<head>
    ...
    <script>
    function updateCartItem(obj,id_products){
        $.get("cartAction.php", {action:"updateCartItem", id_products:id_products, qty:obj.value}, function(data){
            if(data == 'ok'){
                location.reload();
            }else{
...
<div class="panel-body">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td>
                <a href="AccionCarta.php?action=removeCartItem&id_products=<?php echo $item["rowid"]; ?>" class="btn btn-danger" onclick="return confirm('Confirma eliminar?')"><i class="glyphicon glyphicon-trash"></i></a>
            </td>
        </tr>
        <?php } }else{ ?>
 ...
 <div class="panel-footer">Miztli</div>
 </div><!--Panek cierra-->
